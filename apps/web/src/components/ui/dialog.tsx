/**
 * @file dialog.tsx
 * @description A modal dialog component built with Radix UI primitives.
 * Provides accessible modal dialogs with animations and customizable content.
 */
 ...
 * Includes animations and positioning
 * @component
 */
